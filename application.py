...
def query1():
    derror1 = request.form['derror1']
    derror2 = request.form['derror2']
    long = request.form['long']


    sql = "select latitude,longitude,time,depthError from quake6_1 where longitude > {} and depthError between {} and {}".format(long, derror1, derror2)
